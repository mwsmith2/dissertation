...
\newcommand{\bmagic}{$1.4513\;T$\xspace}
\newcommand{\rmagic}{$7.112\;m$\xspace}
\newcommand{\pmagic}{$3.094\;GeV/c$\xspace}
\newcommand{\gev}[1]{$#1\;GeV/c$\xspace}
\newcommand{\ppm}[1]{$#1\;ppm$\xspace}
\newcommand{\ppb}[1]{$#1\;ppb$\xspace}
\newcommand{\val}[2]{$#1\;#2$\xspace}
\newcommand{\fps}{Fixed Probe System}
