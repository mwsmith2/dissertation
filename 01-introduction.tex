...
\caption{
    The plot depicts characteristics of the muon decay in the rest frame.  The decay rate, $n(y)$, and the decay asymmetry, $a(y)$, are shown as a function of fraction energy, $y=E/E_{max}$.
...
\begin{figure}
\centering
\includegraphics[width=1.0\linewidth]{fig/intro-cern-ii-storage-ring}
\caption{
...
\begin{figure}
\centering
\includegraphics[width=1.0\linewidth]{fig/intro-cern-iii-storage-ring}
\caption{
