...
The \gmtwo experiment has stringent requirements on the measurement uncertainty of the magnetic field value.  Stringent enough to aim for an entire error budget on the field uncertainty which is systematic.  Each individual measurement needs to be precise enough that the statistical error of the combined field value is negligible.  This led to an uncertainty goal of \ppb{10} for each probe measurement \todo{find reference}.  The experiment deploys a custom magnetometer system to measure the field.  The custom magnetometers use pulsed proton nuclear magnetic resonance (pNMR), a reprise of the measurement technique used in E821.  The probes were designed to have a very high Q-value resonance at the expected resonance frequency of protons in the magnetic field.
...
\todo{block diagram of the fixed probe system}
